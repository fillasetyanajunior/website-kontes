...
<div class="row" style="margin-top: 3rem">
    ...
    <div class="col-md-9">
        ...
        <div class="canvas" id="html-content-holder">
            <canvas id=canvas width="1500" height="430" style="margin-top: 110px"></canvas>
...
<script type="text/javascript">
    ...
    $('#widthcanvas').keyup(function () {
        ...
        if (widthcanvas == '1500' && heightcamvas == '430') {
    ...
    $('#heightcanvas').keyup(function () {
        ...
        } else if (widthcanvas == width && heightcamvas == '430') {
            $('.upper-canvas').attr('height', height);
            $('.canvas-container').attr('height', height);
            $('#canvas').attr('height', height);
        } else {
