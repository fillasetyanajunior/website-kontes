                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center text-uppercase">
                            <a href="/briefcontest/{{$id}}" class="btn-primary btn-lg btn-block" style="text-decoration: none;text-align: center;width: 500px">i agree with the terms the agreement above</a>
                        </div>
                    </div>
                </div>
            </div>
