        ...
        <tbody>
            <tr>
                <td style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                    <p style="font-size:16px; color:#333333; ">File Upload</p>
                </td>
            </tr>
            @foreach ($uploadfile as $itemuploadfile)
            <tr>
                <td style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                    <p style="font-size:16px; color:#333333; ">{{$itemuploadfile->name}}</p>
                </td>
            </tr>
            @endforeach
        </tbody>
